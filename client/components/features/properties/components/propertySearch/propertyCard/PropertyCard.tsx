    ...
    <div className="group bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col h-full">
      ...
      <div className="relative h-64 w-full overflow-hidden bg-gray-100">
        ...
        <div className="absolute top-4 left-4 flex gap-2">
          <Badge
            className={`${
              property.status === "for_sale" ? "bg-blue-600" : "bg-green-600"
            } text-white`}
          >
        ...
        <div className="absolute bottom-4 left-4">
          <span className="bg-white/95 backdrop-blur-sm px-3 py-1 rounded-lg text-lg font-bold text-gray-900 shadow-sm">
